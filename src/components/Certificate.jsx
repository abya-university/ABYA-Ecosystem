...
const Certificate = ({ certificateData }) => {
  ...
  return (
    <div>
      <div className="mx-auto flex items-center justify-center flex-col mt-[1px] p-2">
          ...
          <div className="overlap-wrapper">
            <div className="overlap">
              ...
              <div className="group-5">
                ...
                <p className="text-wrapper-9 flex mx-auto flex-col items-start justify-start w-full">
                  Certificate ID: <span>{certificateData.certificateId}</span>
                </p>
                <img
...
Certificate.propTypes = {
  certificateData: PropTypes.shape({
    certificateId: PropTypes.oneOfType([PropTypes.string, PropTypes.number])
      .isRequired,
