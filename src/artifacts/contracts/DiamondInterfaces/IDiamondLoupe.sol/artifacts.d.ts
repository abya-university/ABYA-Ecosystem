...
export interface IDiamondLoupe$Type {
  ...
  readonly sourceName: "contracts/DiamondInterfaces/IDiamondLoupe.sol";
  ...
  readonly inputSourceName: "project/contracts/DiamondInterfaces/IDiamondLoupe.sol";
...
declare module "hardhat/types/artifacts" {
  interface ArtifactMap {
    ...
    ["contracts/DiamondInterfaces/IDiamondLoupe.sol:IDiamondLoupe"]: IDiamondLoupe$Type;
  }
}